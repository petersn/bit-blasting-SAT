...
Further, [Glucose](http://www.labri.fr/perso/lsimon/glucose/) (a competitive modern SAT solver) can take the SAT instances generated by `toyfish_attack.py` and even break the 3 round version of full 64-bit Toyfish in about 30 seconds.
